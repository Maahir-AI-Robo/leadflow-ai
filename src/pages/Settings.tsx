      ...
      items: [
        {
          icon: Linkedin,
          label: "LinkedIn",
          description: "Opens via your phone app",
          action: "link",
          onPress: () => toast({ title: "LinkedIn Ready", description: "LinkedIn opens your personal app to message leads directly." }),
        },
        {
          icon: Mail,
          label: "Email",
          description: "Resend integration active",
          action: "link",
          onPress: () => toast({ title: "Email Active", description: "Emails are sent via Resend. Contact admin to update settings." }),
        },
        {
          icon: MessageSquare,
          label: "WhatsApp",
          description: "Opens via your phone app",
          action: "link",
          onPress: () => toast({ title: "WhatsApp Ready", description: "WhatsApp messages open in your personal app for direct sending." }),
        },
      ],
    },
    {
